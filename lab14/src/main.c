...
if(check_files(input_file,output_file)!=0) {
    destroy_arr((void*)errstr);
    errstr=strdup("No read/write access or create directory\n");
    errcode = 1;
    goto END;
}
...
//There are checks for a nullptr inside of the memory dealocation functions. So i can make my life easier
