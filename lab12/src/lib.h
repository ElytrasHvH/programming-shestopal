...
/**
 * Обчислює визначник вхідної матриці.
 *
 ...
 *
 * @param length Вказівник на змінну, де буде збережена довжина рядка.
 * @param filled Вказівник на прапорець, що позначає, чи був ввід користувача не пустим.
 * @return Вказівник на рядок, який містить ввід користувача.
 */
 ...
 */
bool split_string_into_words(const char *str, char ***words, int *numWords);
 ...
 * @param length Вказівник на змінну, де буде збережено довжину рядка (кількість символів).
