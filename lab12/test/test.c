...
END_TEST
// Test case for the read_input function
...
{
    char* result1 = filter_string("123.45e-6");
    ck_assert_str_eq(result1, "123.45e-6");
    free(result1);

    char* result2 = filter_string("abc123.45E-6def");
    ck_assert_str_eq(result2, "123.45e-6");
    free(result2);

    char* result3 = filter_string("abc");
    ck_assert(result3 == NULL);

    char* result4 = filter_string("1.2.3.4e5.6.7");
    ck_assert_str_eq(result4, "1.234e5.67");
    free(result4);

    char* result5 = filter_string("-1-2-3e-4-5-6");
